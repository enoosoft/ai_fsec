...
Original file is located at
    https://colab.research.google.com/drive/1t3qEo1E_LFNGNQR0a924Yz7IEI_aMWL_
...
이진 분류 : 둘 중 하나로만 분류하면 되는 경우.  
다중 클래스 분류 : 분류하고자 하는 선택지가 3개 이상인 경우.

다중 클래스 분류인 경우  
- 모델의 맨 끝단 : Dense(분류하고자 하는 클래스의 개수, activation='softmax')  
- model.compile(loss='categorial_crossentropy')  

이진 분류인 경우  
- 모델의 맨 끝단 : Dense(1, activation='sigmoid')  
